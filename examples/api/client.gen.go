...
func (c *Client) Echo(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewEchoRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
type ClientWithResponsesInterface interface {
	...
	EchoWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*EchoResponse, error)
}
...
func (c *ClientWithResponses) EchoWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*EchoResponse, error) {
	rsp, err := c.Echo(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
